...
MENTIONS_BY_USERS_FILE = '../tweet_entities_analysis/tweets_by_user_covid/mentions_tweets_by_user_covid.csv'
TWEETS_FOLDER = '../filtered_data/covid_tweets_by_politician/'
QUOTE_TWEETS_FOLDER = '../filtered_data/quote_covid_tweets/'
...
# nx.write_gexf(G, 'multi_graph_covid.gexf')